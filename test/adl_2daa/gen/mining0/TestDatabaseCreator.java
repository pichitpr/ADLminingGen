...
public class TestDatabaseCreator {
	...
	public void testCreateDBForParallel(){
		...
		while(it.hasNext()){
			...
			case 0: //FlameMan.base
				assertEquals(1+6, graph.getNodeCount());
				assertEquals(graph.getNodeCount()-1, graph.getEdgeCount());
				break;
			case 1: //FlameMan.flame
				assertEquals(1+15, graph.getNodeCount());
				assertEquals(graph.getNodeCount()-1, graph.getEdgeCount());
				break;
			case 2: //FlameMan.bullet
				assertEquals(1+8+2, graph.getNodeCount());
				assertEquals(graph.getNodeCount()-1, graph.getEdgeCount());
				break;
			case 3: //FlameShield.state0
				assertEquals(1+7, graph.getNodeCount());
				assertEquals(graph.getNodeCount()-1, graph.getEdgeCount());
				break;
			case 4: //FlameShot.state0
				assertEquals(1+2, graph.getNodeCount());
				assertEquals(graph.getNodeCount()-1, graph.getEdgeCount());
				break;
			case 5: //ShellKoopa.state0
				assertEquals(1+2+2, graph.getNodeCount());
				assertEquals(graph.getNodeCount()-1, graph.getEdgeCount());
				break;
			case 6: //Koopa.state0
				assertEquals(1+3, graph.getNodeCount());
				assertEquals(graph.getNodeCount()-1, graph.getEdgeCount());
				break;
			...
			case 8: //KoopaShell.state1
				assertEquals(1+3+3, graph.getNodeCount());
				assertEquals(graph.getNodeCount()-1, graph.getEdgeCount());
				break;
			...
			case 12: //TomahawkMan.base
				assertEquals(1+7+2, graph.getNodeCount());
				assertEquals(graph.getNodeCount()-1, graph.getEdgeCount());
				break;
			...
			case 14: //TomahawkMan.tomahawk
				assertEquals(1+4, graph.getNodeCount());
				assertEquals(graph.getNodeCount()-1, graph.getEdgeCount());
				break;
	...
	public void testCreateDBForInterEntityParallel(){
		...
		while(it.hasNext()){
			...
			case 6: case 7: case 8:
				//FlameMan.bullet(2) -> Spawn .FlameShot(1) *3
	...
	public void testCreateDBforNesting(){
		...
		int flameManGraph = (9+7+14+7+1)+(8+6)+(7+1);
