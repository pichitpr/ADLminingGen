...
public class FlowAnalyzableTree {
	 ...
	 */
	protected void addAction(EncodedAction action){
	 ...
	 */
	protected void createFlowAndTrim(List<EncodedAction> list){
	...
	private void addAllActionsTo(List<EncodedAction> list, boolean recursiveParent){
		addAllActionsTo(list, content.size()-1, recursiveParent);
	}
	
	private void addAllActionsTo(List<EncodedAction> list, int startingIndex,
	...
	private abstract class TreeNode{
		protected abstract void addAllActionsTo(List<EncodedAction> list);
	}
	
	private class TreeEncodedActionNode extends TreeNode{
		protected EncodedAction action = null;

		@Override
		protected void addAllActionsTo(List<EncodedAction> list) {
			list.add(action);
		}
	}
